...
- Оплата: Telegram Payments. Токен провайдера — у @BotFather
  (/mybots → Payments), положите его в `.env` как `PAYMENT_PROVIDER_TOKEN`.
  Без токона кнопка оплаты честно скажет, что оплата не настроена.
